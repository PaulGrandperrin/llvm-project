...
// define void @test_FOO_pass(%struct.FOO* noalias sret %agg.result, %struct.FOO* byval(%struct.FOO) align 8 %p) #0 !noalias !21 {
// CHECK: void @test_FOO_pass(%struct.FOO* noalias sret %agg.result, %struct.FOO* byval(%struct.FOO) align 8 %p) #0 !noalias [[TAG_21:!.*]] {
...
// define void @test_FUM_pass(%struct.FUM* noalias sret %agg.result, %struct.FUM* byval(%struct.FUM) align 8 %p) #0 !noalias !41 {
// CHECK: void @test_FUM_pass(%struct.FUM* noalias sret %agg.result, %struct.FUM* byval(%struct.FUM) align 8 %p) #0 !noalias [[TAG_41:!.*]] {
...
// CHECK: [[TAG_25]] = !{i64 -1, i64 0}
// CHECK: [[TAG_26]] = !{i64 -1, i64 1}
// CHECK: [[TAG_27]] = !{i64 -1, i64 2}

// CHECK: [[TAG_44]] = !{[[TAG_45:!.*]], [[TAG_46:!.*]], [[TAG_47:!.*]]}
// CHECK: [[TAG_45]] = !{i64 -1, i64 0, i64 0}
// CHECK: [[TAG_46]] = !{i64 -1, i64 0, i64 1}
// CHECK: [[TAG_47]] = !{i64 -1, i64 0, i64 2}
