...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  store i32 42, i32* %cond, noalias_sidechannel i32* undef, align 4, !tbaa !2
  store i32 99, i32* %_pC, noalias_sidechannel i32* undef, align 4, !tbaa !2
  ret void
}
; CHECK-LABEL: Function: test_phi_p_p_p:
; CHECK:  MayAlias:   store i32 99, i32* %_pC, noalias_sidechannel i32* undef, align 4, !tbaa !2 <->   store i32 42, i32* %cond, noalias_sidechannel i32* undef, align 4, !tbaa !2
...
entry:
  ...
  %1 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pA, i8* %0, i32** null, i32** undef, i32 0, metadata !6)
  br i1 %tobool, label %cond.false, label %cond.true
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32* [ %_pA, %cond.true ], [ %_pB, %cond.false ]
  %side.cond = phi i32* [ %1, %cond.true ], [ %_pB, %cond.false ]
  store i32 42, i32* %cond, noalias_sidechannel i32* %side.cond, align 4, !tbaa !2, !noalias !6
  store i32 99, i32* %_pC, noalias_sidechannel i32* undef, align 4, !tbaa !2, !noalias !6
  ret void
}
; CHECK-LABEL: Function: test_phi_rp_p_p:
; CHECK:  MayAlias:   store i32 99, i32* %_pC, noalias_sidechannel i32* undef, align 4, !tbaa !5, !noalias !2 <->   store i32 42, i32* %cond, noalias_sidechannel i32* %side.cond, align 4, !tbaa !5, !noalias !2
...
entry:
  ...
  %tobool = icmp ne i32 %c, 0
  %1 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pB, i8* %0, i32** null, i32** undef, i32 0, metadata !9)
  br i1 %tobool, label %cond.false, label %cond.true
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32* [ %_pA, %cond.true ], [ %_pB, %cond.false ]
  %side.cond = phi i32* [ %_pA, %cond.true ], [ %1, %cond.false ]
  store i32 42, i32* %cond, noalias_sidechannel i32* %side.cond, align 4, !tbaa !2, !noalias !9
  store i32 99, i32* %_pC, noalias_sidechannel i32* undef, align 4, !tbaa !2, !noalias !9
  ret void
}
...
entry:
  ...
  %tobool = icmp ne i32 %c, 0
  %2 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pA, i8* %0, i32** null, i32** undef, i32 0, metadata !12)
  %3 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pB, i8* %1, i32** null, i32** undef, i32 0, metadata !15)
  br i1 %tobool, label %cond.false, label %cond.true
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32* [ %_pA, %cond.true ], [ %_pB, %cond.false ]
  %side.cond = phi i32* [ %2, %cond.true ], [ %3, %cond.false ]
  store i32 42, i32* %cond, noalias_sidechannel i32* %side.cond, align 4, !tbaa !2, !noalias !17
  store i32 99, i32* %_pC, noalias_sidechannel i32* undef, align 4, !tbaa !2, !noalias !17
  ret void
}
; CHECK-LABEL: Function: test_phi_rp_rp_p:
; CHECK:  NoAlias:   store i32 99, i32* %_pC, noalias_sidechannel i32* undef, align 4, !tbaa !7, !noalias !11 <->   store i32 42, i32* %cond, noalias_sidechannel i32* %side.cond, align 4, !tbaa !7, !noalias !11
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32* [ %_pA, %cond.true ], [ %_pB, %cond.false ]
  store i32 42, i32* %cond, noalias_sidechannel i32* undef, align 4, !tbaa !2, !noalias !18
  %1 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pC, i8* %0, i32** null, i32** undef, i32 0, metadata !18), !tbaa !21, !noalias !18
  store i32 99, i32* %_pC, noalias_sidechannel i32* %1, align 4, !tbaa !2, !noalias !18
  ret void
}
; CHECK-LABEL: Function: test_phi_p_p_rp:
; CHECK:  NoAlias:   store i32 99, i32* %_pC, noalias_sidechannel i32* %1, align 4, !tbaa !5, !noalias !2 <->   store i32 42, i32* %cond, noalias_sidechannel i32* undef, align 4, !tbaa !5, !noalias !2
...
entry:
  ...
  %tobool = icmp ne i32 %c, 0
  %3 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pA, i8* %0, i32** null, i32** undef, i32 0, metadata !23)
  %4 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pB, i8* %1, i32** null, i32** undef, i32 0, metadata !26)
  br i1 %tobool, label %cond.false, label %cond.true
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32* [ %_pA, %cond.true ], [ %_pB, %cond.false ]
  %side.cond = phi i32* [ %3, %cond.true ], [ %4, %cond.false ]
  store i32 42, i32* %cond, noalias_sidechannel i32* %side.cond, align 4, !tbaa !2, !noalias !30
  %5 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pC, i8* %2, i32** null, i32** undef, i32 0, metadata !28), !tbaa !21, !noalias !30
  store i32 99, i32* %_pC, noalias_sidechannel i32* %5, align 4, !tbaa !2, !noalias !30
  ret void
}

; CHECK-LABEL: Function: test_phi_rp_rp_rp_01:
; CHECK:  NoAlias:   store i32 99, i32* %_pC, noalias_sidechannel i32* %5, align 4, !tbaa !9, !noalias !13 <->   store i32 42, i32* %cond, noalias_sidechannel i32* %side.cond, align 4, !tbaa !9, !noalias !13
...
entry:
  ...
  %tobool = icmp ne i32 %c, 0
  %2 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pA, i8* %0, i32** null, i32** undef, i32 0, metadata !31)
  %3 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pC, i8* %1, i32** null, i32** undef, i32 0, metadata !34)
  br i1 %tobool, label %cond.false, label %cond.true
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %side.cond = phi i32* [ %2, %cond.true ], [ %3, %cond.false ]
  store i32 42, i32* %cond, noalias_sidechannel i32* %side.cond, align 4, !tbaa !2, !noalias !36
  store i32 99, i32* %_pC, noalias_sidechannel i32* %3, align 4, !tbaa !2, !noalias !36
  ret void
}
; CHECK-LABEL: Function: test_phi_rp_rp_rp_02:
; CHECK:  MayAlias:   store i32 99, i32* %_pC, noalias_sidechannel i32* %3, align 4, !tbaa !7, !noalias !11 <->   store i32 42, i32* %cond, noalias_sidechannel i32* %side.cond, align 4, !tbaa !7, !noalias !11

; Function Attrs: nounwind readnone speculatable
declare i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32*, i8*, i32**, i32**, i32, metadata) #3
