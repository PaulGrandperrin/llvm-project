...
entry:
  ...
  %side.cond = select i1 %tobool, i32* %1, i32* %_pB
...
entry:
  ...
  %side.cond = select i1 %tobool, i32* %_pA, i32* %1
  %cond = select i1 %tobool, i32* %_pA, i32* %_pB
...
entry:
  ...
  %side.cond = select i1 %tobool, i32* %2, i32* %3
  %cond = select i1 %tobool, i32* %_pA, i32* %_pB
...
entry:
  ...
  %side.cond = select i1 %tobool, i32* %3, i32* %4
  %cond = select i1 %tobool, i32* %_pA, i32* %_pB
