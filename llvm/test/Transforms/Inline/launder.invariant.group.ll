...
; RUN: opt -S -O3 --use-noalias-intrinsic-during-inlining=1 < %s | FileCheck %s --check-prefixes=CHECK,CHECK_SIDE,CHECK_OPT
...
define i32 @foo(%struct.A* noalias)  {
  ...
  ; CHECK_SIDE-NOT: call i32 @bar(
  ; CHECK_SIDE: @llvm.noalias.decl.p0
  ; CHECK_SIDE-NEXT: @llvm.side.noalias.p0
  ; CHECK_SIDE-NOT: call i32 @bar(
  ; CHECK_SIDE: @llvm.noalias.arg.guard.p0
  ; CHECK_SIDE-NOT: call i32 @bar(
