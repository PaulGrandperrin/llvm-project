...
entry:
  %0 = load i32, i32* %src, noalias_sidechannel i32* undef, align 4, !tbaa !2
  store i32 %0, i32* %dst, noalias_sidechannel i32* undef, align 4, !tbaa !2
  ret void
}
...
entry:
  ...
  %2 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %src, i8* %1, i32** null, i32** undef, i64 0, metadata !9), !tbaa !11, !noalias !13
  %3 = load i32, i32* %src, noalias_sidechannel i32* %2, align 4, !tbaa !2, !noalias !13
  %4 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %dst, i8* %0, i32** null, i32** undef, i64 0, metadata !6), !tbaa !11, !noalias !13
  store i32 %3, i32* %dst, noalias_sidechannel i32* %4, align 4, !tbaa !2, !noalias !13
  ret void
}
...
; INTR-SCOPE:   %4 = load i32, i32* %3, noalias_sidechannel i32* undef, align 4, !tbaa !2, !noalias !19
; INTR-SCOPE:   store i32 %4, i32* %1, noalias_sidechannel i32* undef, align 4, !tbaa !2, !noalias !19
...
; INTR-SCOPE:   %9 = load i32, i32* %8, noalias_sidechannel i32* undef, align 4, !tbaa !2, !noalias !25
; INTR-SCOPE:   store i32 %9, i32* %6, noalias_sidechannel i32* undef, align 4, !tbaa !2, !noalias !25
...
; INTR-SCOPE:   %14 = load i32, i32* %13, noalias_sidechannel i32* undef, align 4, !tbaa !2, !noalias !31
; INTR-SCOPE:   store i32 %14, i32* %11, noalias_sidechannel i32* undef, align 4, !tbaa !2, !noalias !31
...
; INTR-SCOPE:   %2 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %src, i8* %1, i32** null, i32** undef, i64 0, metadata !35) #5, !tbaa !11, !noalias !37
; INTR-SCOPE:   %3 = load i32, i32* %src, noalias_sidechannel i32* %2, align 4, !tbaa !2, !noalias !37
; INTR-SCOPE:   %4 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %dst, i8* %0, i32** null, i32** undef, i64 0, metadata !32) #5, !tbaa !11, !noalias !37
; INTR-SCOPE:   store i32 %3, i32* %dst, noalias_sidechannel i32* %4, align 4, !tbaa !2, !noalias !37
; INTR-SCOPE:   br label %do.body
; INTR-SCOPE: do.body:                                          ; preds = %do.body, %entry
; INTR-SCOPE:   %n.addr.0 = phi i32 [ %n, %entry ], [ %dec, %do.body ]
...
; INTR-SCOPE:   %7 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %src, i8* %6, i32** null, i32** undef, i64 0, metadata !41) #5, !tbaa !11, !noalias !43
; INTR-SCOPE:   %8 = load i32, i32* %src, noalias_sidechannel i32* %7, align 4, !tbaa !2, !noalias !43
; INTR-SCOPE:   %9 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %dst, i8* %5, i32** null, i32** undef, i64 0, metadata !38) #5, !tbaa !11, !noalias !43
; INTR-SCOPE:   store i32 %8, i32* %dst, noalias_sidechannel i32* %9, align 4, !tbaa !2, !noalias !43
...
; INTR-SCOPE:   %12 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %src, i8* %11, i32** null, i32** undef, i64 0, metadata !47) #5, !tbaa !11, !noalias !49
; INTR-SCOPE:   %13 = load i32, i32* %src, noalias_sidechannel i32* %12, align 4, !tbaa !2, !noalias !49
; INTR-SCOPE:   %14 = tail call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %dst, i8* %10, i32** null, i32** undef, i64 0, metadata !44) #5, !tbaa !11, !noalias !49
; INTR-SCOPE:   store i32 %13, i32* %dst, noalias_sidechannel i32* %14, align 4, !tbaa !2, !noalias !49
; INTR-SCOPE:   %dec = add nsw i32 %n.addr.0, -1
; INTR-SCOPE:   %tobool = icmp eq i32 %n.addr.0, 0
; INTR-SCOPE:   br i1 %tobool, label %do.end, label %do.body
; INTR-SCOPE: do.end:                                           ; preds = %do.body
