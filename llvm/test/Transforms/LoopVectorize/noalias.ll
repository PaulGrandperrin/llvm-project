...
; A used llvm.side.noalias should NOT block vectorization.
; CHECK-LABEL: @test_side_noalias(
; CHECK: @llvm.side.noalias.p0i32
; NOTE: the noalias_sidechannel is omitted
; CHECK: store <2 x i32> <i32 100, i32 100>, <2 x i32>* {{%[0-9.a-zA-Z]*}}, align 8
; CHECK: ret

define void @test_side_noalias(i32 *%d) {
entry:
  br label %for.body

for.body:
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %for.body ]
  %side.d = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %d, i8* null, i32** null, i32** null, i32 0, metadata !1)
  %arrayidx = getelementptr inbounds i32, i32* %d, i64 %indvars.iv
  %v1 = load i32, i32* %arrayidx, noalias_sidechannel i32* %side.d, align 8
  store i32 100, i32* %arrayidx, noalias_sidechannel i32* %side.d, align 8
  %indvars.iv.next = add i64 %indvars.iv, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32
  %exitcond = icmp ne i32 %lftr.wideiv, 128
  br i1 %exitcond, label %for.body, label %for.end
