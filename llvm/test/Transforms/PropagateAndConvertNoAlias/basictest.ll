...
; CHECK-NEXT:   %0 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pA, i8* %pA.decl, i32** null, i32** undef, i32 0, metadata !2), !tbaa !5, !noalias !2
; CHECK-NEXT:   %arrayidx = getelementptr inbounds i32, i32* %_pA, i32 10
; CHECK-NEXT:   store i32 42, i32* %arrayidx, noalias_sidechannel i32* %0, align 4, !tbaa !9, !noalias !2
...
; CHECK-NEXT:   store i32 43, i32* %arrayidx1, noalias_sidechannel i32* %0, align 4, !tbaa !9, !noalias !2
; CHECK-NEXT:   ret void
; CHECK-NEXT: }
...
; CHECK-NEXT:   %0 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pA, i8* %pA.decl, i32** null, i32** undef, i32 0, metadata !11), !tbaa !5, !noalias !11
; CHECK-NEXT:   store i32* %_pA, i32** @gpA, noalias_sidechannel i32** undef, align 4, !tbaa !5, !noalias !11
