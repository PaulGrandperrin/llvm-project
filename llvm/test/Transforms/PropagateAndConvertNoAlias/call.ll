...
; CHECK-NEXT:   store i32 42, i32* %_pA, noalias_sidechannel i32* %1, align 4, !tbaa !9, !noalias !2
...
; CHECK-NEXT:   %1 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pA, i8* %0, i32** null, i32** undef, i32 0, metadata !11), !tbaa !5, !noalias !11
; CHECK-NEXT:   store i32 41, i32* %_pA, noalias_sidechannel i32* %1, align 4, !tbaa !9, !noalias !11
; CHECK-NEXT:   %.guard = call i32* @llvm.noalias.arg.guard.p0i32.p0i32(i32* %_pA, i32* %1)
; CHECK-NEXT:   %call = call i32* @passP(i32* %.guard), !noalias !11
; CHECK-NEXT:   store i32 43, i32* %call, noalias_sidechannel i32* undef, align 4, !tbaa !9, !noalias !11
; CHECK-NEXT:   ret void
; CHECK-NEXT: }
...
; CHECK: block:
; CHECK-NEXT:   %side.tmp0 = phi i32* [ %1, %entry ]
; CHECK-NEXT:   %tmp0 = phi i32* [ %_pA, %entry ]
; CHECK-NEXT:   %side.tmp1 = phi i32* [ %1, %entry ]
; CHECK-NEXT:   %tmp1 = phi i32* [ %_pA, %entry ]
; CHECK-NEXT:   %tmp0.guard = call i32* @llvm.noalias.arg.guard.p0i32.p0i32(i32* %tmp0, i32* %side.tmp0)
