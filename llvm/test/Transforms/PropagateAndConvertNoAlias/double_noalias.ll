...
; CHECK-NEXT:   %1 = call i32** @llvm.side.noalias.p0p0i32.p0i8.p0p0p0i32.p0p0p0i32.i32(i32** %_p, i8* %0, i32*** null, i32*** undef, i32 0, metadata !5), !tbaa !7, !noalias !11
; CHECK-NEXT:   %arrayidx = getelementptr inbounds i32*, i32** %_p, i32 1
; CHECK-NEXT:   %2 = load i32*, i32** %arrayidx, noalias_sidechannel i32** %1, align 4, !tbaa !7, !noalias !11
; CHECK-NEXT:   %3 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %2, i8* null, i32** %arrayidx, i32** %1, i32 0, metadata !2), !tbaa !7, !noalias !11
; CHECK-NEXT:   %arrayidx1 = getelementptr inbounds i32, i32* %2, i32 2
; CHECK-NEXT:   %4 = load i32, i32* %arrayidx1, noalias_sidechannel i32* %3, align 4, !tbaa !12, !noalias !11
; CHECK-NEXT:   %add = add nsw i32 %4, 1
; CHECK-NEXT:   %5 = load i32*, i32** %_p, noalias_sidechannel i32** %1, align 4, !tbaa !7, !noalias !11
; CHECK-NEXT:   %6 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %5, i8* null, i32** %_p, i32** %1, i32 0, metadata !2), !tbaa !7, !noalias !11
; CHECK-NEXT:   store i32 %add, i32* %5, noalias_sidechannel i32* %6, align 4, !tbaa !12, !noalias !11
; CHECK-NEXT:   ret void
; CHECK-NEXT: }
