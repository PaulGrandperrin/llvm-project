...
entry:
  ...
  %1 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_f, i8* %0, i32** null, i32** undef, i32 0, metadata !2), !tbaa !5, !noalias !2
  %2 = bitcast i32* %1 to %struct.a*
  %3 = bitcast i32* %_f to %struct.a*
  br label %for.cond

for.cond:                                         ; preds = %for.cond, %entry
  %side.h.0 = phi %struct.a* [ %2, %entry ], [ %h.0.guard, %for.cond ]
  %h.0 = phi %struct.a* [ %3, %entry ], [ %h.0.guard, %for.cond ]
  %h.0.guard = call %struct.a* @llvm.noalias.arg.guard.p0s_struct.as.p0s_struct.as(%struct.a* %h.0, %struct.a* %side.h.0)
  %4 = getelementptr inbounds %struct.a, %struct.a* %h.0, i32 0, i32 0
  %.unpack = load i8, i8* %4, noalias_sidechannel %struct.a* %side.h.0, align 1, !noalias !2
...
; CHECK-NEXT:   %1 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_f, i8* %0, i32** null, i32** undef, i32 0, metadata !2), !tbaa !5, !noalias !2
; CHECK-NEXT:   %2 = bitcast i32* %1 to %struct.a*
; CHECK-NEXT:   %3 = bitcast i32* %_f to %struct.a*
; CHECK-NEXT:   br label %for.cond
; CHECK:      for.cond:                                         ; preds = %for.cond, %entry
; CHECK-NEXT:   %side.h.0 = phi %struct.a* [ %2, %entry ], [ %side.h.0, %for.cond ]
; CHECK-NEXT:   %side.h.01 = phi %struct.a* [ %3, %entry ], [ %side.h.0, %for.cond ]
; CHECK-NEXT:   %h.0 = phi %struct.a* [ %3, %entry ], [ %h.0, %for.cond ]
; CHECK-NEXT:   %4 = getelementptr inbounds %struct.a, %struct.a* %h.0, i32 0, i32 0
; CHECK-NEXT:   %.unpack = load i8, i8* %4, noalias_sidechannel %struct.a* %side.h.0, align 1, !noalias !2
