...
; CHECK-NEXT:   %2 = load i32*, i32** %arrayidx, noalias_sidechannel i32** undef, align 4, !tbaa !7, !noalias !11
; CHECK-NEXT:   %3 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pA, i8* %0, i32** null, i32** undef, i32 0, metadata !2), !tbaa !7, !noalias !11
; CHECK-NEXT:   %4 = load i32*, i32** %_pB, noalias_sidechannel i32** undef, align 4, !tbaa !7, !noalias !11
; CHECK-NEXT:   %arrayidx2 = getelementptr inbounds i32*, i32** %_pB, i32 1
; CHECK-NEXT:   %5 = load i32*, i32** %arrayidx2, noalias_sidechannel i32** undef, align 4, !tbaa !7, !noalias !11
; CHECK-NEXT:   br label %for.cond
; CHECK: for.cond:
; CHECK-NEXT:   %side.pTmp00.0 = phi i32* [ %4, %entry ], [ %side.pTmp01.0, %for.body ]
; CHECK-NEXT:   %pTmp00.0 = phi i32* [ %4, %entry ], [ %pTmp01.0, %for.body ]
; CHECK-NEXT:   %side.pTmp01.0 = phi i32* [ %5, %entry ], [ %3, %for.body ]
...
; CHECK-NEXT:   store i32 99, i32* %_pA, noalias_sidechannel i32* %3, align 4, !tbaa !12, !noalias !11
; CHECK-NEXT:   store i32 42, i32* %pTmp00.0, noalias_sidechannel i32* %side.pTmp00.0, align 4, !tbaa !12, !noalias !11
; CHECK-NEXT:   %cmp5 = icmp sgt i32 %n, 5
; CHECK-NEXT:   %6 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %2, i8* %1, i32** null, i32** undef, i32 0, metadata !5)
; CHECK-NEXT:   %side.cond = select i1 %cmp5, i32* %side.pTmp00.0, i32* %6
; CHECK-NEXT:   %cond = select i1 %cmp5, i32* %pTmp00.0, i32* %2
; CHECK-NEXT:   store i32 43, i32* %cond, noalias_sidechannel i32* %side.cond, align 4, !tbaa !12, !noalias !11
; CHECK-NEXT:   ret void
; CHECK: for.body:
; CHECK-NEXT:   %arrayidx3 = getelementptr inbounds i32, i32* %pTmp01.0, i32 1
; CHECK-NEXT:   %7 = load i32, i32* %arrayidx3, noalias_sidechannel i32* %side.pTmp01.0, align 4, !tbaa !12, !noalias !11
; CHECK-NEXT:   %arrayidx4 = getelementptr inbounds i32, i32* %pTmp00.0, i32 1
; CHECK-NEXT:   store i32 %7, i32* %arrayidx4, noalias_sidechannel i32* %side.pTmp00.0, align 4, !tbaa !12, !noalias !11
...
; CHECK-NEXT:   %arrayidx = getelementptr inbounds i32*, i32** %_pB, i32 2
; CHECK-NEXT:   %2 = load i32*, i32** %arrayidx, noalias_sidechannel i32** undef, align 4, !tbaa !7, !noalias !19
; CHECK-NEXT:   %3 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %_pA, i8* %0, i32** null, i32** undef, i32 0, metadata !14), !tbaa !7, !noalias !19
; CHECK-NEXT:   %4 = load i32*, i32** %_pB, noalias_sidechannel i32** undef, align 4, !tbaa !7, !noalias !19
; CHECK-NEXT:   %arrayidx2 = getelementptr inbounds i32*, i32** %_pB, i32 1
; CHECK-NEXT:   %5 = load i32*, i32** %arrayidx2, noalias_sidechannel i32** undef, align 4, !tbaa !7, !noalias !19
; CHECK-NEXT:   br label %for.cond
; CHECK: for.cond:
; CHECK-NEXT:   %side.pTmp00.0 = phi i32* [ %4, %entry ], [ %side.pTmp01.0, %for.body ]
; CHECK-NEXT:   %pTmp00.0 = phi i32* [ %4, %entry ], [ %pTmp01.0, %for.body ]
...
; CHECK-NEXT:   %pTmp01.0 = phi i32* [ %5, %entry ], [ %_pA, %for.body ]
; CHECK-NEXT:   %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.body ]
; CHECK-NEXT:   %6 = bitcast i32* %side.pTmp00.0 to i16*
; CHECK-NEXT:   %7 = bitcast i32* %side.pTmp01.0 to i16*
; CHECK-NEXT:   %cmp = icmp slt i32 %i.0, %n
; CHECK-NEXT:   br i1 %cmp, label %for.body, label %for.cond.cleanup
; CHECK: for.cond.cleanup:
; CHECK-NEXT:   %8 = bitcast i32* %3 to i16*
; CHECK-NEXT:   %9 = bitcast i32* %_pA to i16*
; CHECK-NEXT:   store i16 99, i16* %9, noalias_sidechannel i16* %8, align 2, !tbaa !20, !noalias !19
; CHECK-NEXT:   %10 = bitcast i32* %pTmp00.0 to i16*
; CHECK-NEXT:   store i16 42, i16* %10, noalias_sidechannel i16* %6, align 2, !tbaa !20, !noalias !19
; CHECK-NEXT:   %cmp5 = icmp sgt i32 %n, 5
; CHECK-NEXT:   %11 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i32(i32* %2, i8* %1, i32** null, i32** undef, i32 0, metadata !17)
; CHECK-NEXT:   %side.cond = select i1 %cmp5, i32* %side.pTmp00.0, i32* %11
; CHECK-NEXT:   %12 = bitcast i32* %side.cond to i16*
; CHECK-NEXT:   %cond = select i1 %cmp5, i32* %pTmp00.0, i32* %2
; CHECK-NEXT:   %13 = bitcast i32* %cond to i16*
; CHECK-NEXT:   store i16 43, i16* %13, noalias_sidechannel i16* %12, align 2, !tbaa !20, !noalias !19
; CHECK-NEXT:   ret void
; CHECK: for.body:
; CHECK-NEXT:   %14 = bitcast i32* %pTmp01.0 to i16*
; CHECK-NEXT:   %arrayidx3 = getelementptr inbounds i16, i16* %14, i32 1
; CHECK-NEXT:   %15 = load i16, i16* %arrayidx3, noalias_sidechannel i16* %7, align 2, !tbaa !20, !noalias !19
; CHECK-NEXT:   %16 = bitcast i32* %pTmp00.0 to i16*
; CHECK-NEXT:   %arrayidx4 = getelementptr inbounds i16, i16* %16, i32 1
; CHECK-NEXT:   store i16 %15, i16* %arrayidx4, noalias_sidechannel i16* %6, align 2, !tbaa !20, !noalias !19
; CHECK-NEXT:   %inc = add nsw i32 %i.0, 1
; CHECK-NEXT:   br label %for.cond
; CHECK-NEXT: }
...
!1 = !{!"clang version 10.0.0 (sgasip@krachtcs10:/u/sgasip/ipd/repositories/llvm_ipd 6068136b7c40a5bb7a7291dd621185a209673e09)"}
!2 = !{!3}
