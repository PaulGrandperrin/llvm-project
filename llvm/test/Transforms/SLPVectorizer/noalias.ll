...
; SLP vectorization across a @llvm.side.noalias and side channel
...
; CHECK-NEXT:    [[SIDE_P1:%.*]] = tail call float* @llvm.side.noalias.p0f32.p0i8.p0p0f32.p0p0f32.i32(float* [[P1]], i8* [[P1_DECL]], float** null, float** undef, i32 0, metadata !0), !noalias !0
...
;
  ...
  %side.p1 = tail call float* @llvm.side.noalias.p0f32.p0i8.p0p0f32.p0p0f32.i32(float* %p1, i8* %p1.decl, float** null, float** undef, i32 0, metadata !0), !noalias !0
  %p2 = getelementptr float, float* %p, i64 2
  %p3 = getelementptr float, float* %p, i64 3
  %l0 = load float, float* %p0, !noalias !0
  %l1 = load float, float* %p1, noalias_sidechannel float* %side.p1, !noalias !0
  %l2 = load float, float* %p2, !noalias !0
  call void @llvm.sideeffect()
  %l3 = load float, float* %p3, !noalias !0
  store float %l0, float* %p0, !noalias !0
  call void @llvm.sideeffect()
  store float %l1, float* %p1, noalias_sidechannel float* %side.p1, !noalias !0
...
declare float* @llvm.side.noalias.p0f32.p0i8.p0p0f32.p0p0f32.i32(float*, i8*, float**, float**, i32, metadata) #2
