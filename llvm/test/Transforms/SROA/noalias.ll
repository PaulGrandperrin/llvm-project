...
entry:
  ...
  store i32* %_p, i32** %rp, noalias_sidechannel i32** undef, align 4, !noalias !24
  %2 = load i32*, i32** %rp, noalias_sidechannel i32** undef, align 4, !noalias !28
  %3 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %2, i8* %1, i32** %rp, i32** undef, i64 0, metadata !27) #4, !noalias !28
  store i32 42, i32* %2, noalias_sidechannel i32* %3, align 4, !noalias !28
...
; CHECK:  %1 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %_p, i8* %0, i32** null, i32** undef, i64 0, metadata !24){{.*}}, !noalias !27
...
entry:
  ...
  store i32* %_p, i32** %.fca.0.gep, noalias_sidechannel i32** undef, align 4, !noalias !32
  %arrayinit.element = getelementptr inbounds [3 x i32*], [3 x i32*]* %rp, i32 0, i32 1
  %add.ptr = getelementptr inbounds i32, i32* %_p, i32 1
  store i32* %add.ptr, i32** %arrayinit.element, noalias_sidechannel i32** undef, align 4, !noalias !32
  %arrayinit.element1 = getelementptr inbounds [3 x i32*], [3 x i32*]* %rp, i32 0, i32 2
  %add.ptr2 = getelementptr inbounds i32, i32* %_p, i32 2
  store i32* %add.ptr2, i32** %arrayinit.element1, noalias_sidechannel i32** undef, align 4, !noalias !32
  %2 = load i32*, i32** %.fca.0.gep, noalias_sidechannel i32** undef, align 4, !noalias !36
  %3 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %2, i8* %1, i32** %.fca.0.gep, i32** undef, i64 0, metadata !35) #4, !noalias !36
  store i32 42, i32* %2, noalias_sidechannel i32* %3, align 4, !noalias !36
  %arrayidx1.i = getelementptr inbounds i32*, i32** %.fca.0.gep, i32 1
  %4 = load i32*, i32** %arrayidx1.i, noalias_sidechannel i32** undef, align 4, !noalias !36
  %5 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %4, i8* %1, i32** nonnull %arrayidx1.i, i32** undef, i64 0, metadata !35) #4, !noalias !36
  store i32 43, i32* %4, noalias_sidechannel i32* %5, align 4, !noalias !36
  %arrayidx2.i = getelementptr inbounds i32*, i32** %.fca.0.gep, i32 2
  %6 = load i32*, i32** %arrayidx2.i, noalias_sidechannel i32** undef, align 4, !noalias !36
  %7 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %6, i8* %1, i32** nonnull %arrayidx2.i, i32** undef, i64 0, metadata !35) #4, !noalias !36
  store i32 44, i32* %6, noalias_sidechannel i32* %7, align 4, !noalias !36
...
; CHECK:  %3 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %_p, i8* %0, i32** null, i32** undef, i64 0, metadata !31){{.*}}, !noalias !34
; CHECK:  %4 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %add.ptr, i8* %1, i32** nonnull null, i32** undef, i64 8, metadata !31){{.*}}, !noalias !34
; CHECK:  %5 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %add.ptr2, i8* %2, i32** nonnull null, i32** undef, i64 16, metadata !31){{.*}}, !noalias !34
...
entry:
  ...
  store i32* %_p, i32** %.fca.0.gep, noalias_sidechannel i32** undef, align 4, !noalias !40
  %add.ptr = getelementptr inbounds i32, i32* %_p, i32 1
  store i32* %add.ptr, i32** %.fca.1.gep, noalias_sidechannel i32** undef, align 4, !noalias !40
  %add.ptr1 = getelementptr inbounds i32, i32* %_p, i32 2
  store i32* %add.ptr1, i32** %.fca.2.gep, noalias_sidechannel i32** undef, align 4, !noalias !40
  %mP0.i = getelementptr inbounds %struct.FOO, %struct.FOO* %foo, i32 0, i32 0
  %2 = load i32*, i32** %mP0.i, noalias_sidechannel i32** undef, align 4, !noalias !44
  %3 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %2, i8* %1, i32** %mP0.i, i32** undef, i64 0, metadata !43) #4, !noalias !44
  store i32 42, i32* %2, noalias_sidechannel i32* %3, align 4, !noalias !44
  %mP1.i = getelementptr inbounds %struct.FOO, %struct.FOO* %foo, i32 0, i32 1
  %4 = load i32*, i32** %mP1.i, noalias_sidechannel i32** undef, align 4, !noalias !44
  %5 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %4, i8* %1, i32** nonnull %mP1.i, i32** undef, i64 0, metadata !43) #4, !noalias !44
  store i32 43, i32* %4, noalias_sidechannel i32* %5, align 4, !noalias !44
  %mP2.i = getelementptr inbounds %struct.FOO, %struct.FOO* %foo, i32 0, i32 2
  %6 = load i32*, i32** %mP2.i, noalias_sidechannel i32** undef, align 4, !noalias !44
  %7 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %6, i8* %1, i32** nonnull %mP2.i, i32** undef, i64 0, metadata !43) #4, !noalias !44
  store i32 44, i32* %6, noalias_sidechannel i32* %7, align 4, !noalias !44
...
; CHECK:  %3 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %_p, i8* %0, i32** null, i32** undef, i64 0, metadata !38){{.*}}, !noalias !41
; CHECK:  %4 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %add.ptr, i8* %1, i32** nonnull null, i32** undef, i64 8, metadata !38){{.*}}, !noalias !41
; CHECK:  %5 = call i32* @llvm.side.noalias.p0i32.p0i8.p0p0i32.p0p0i32.i64(i32* %add.ptr1, i8* %2, i32** nonnull null, i32** undef, i64 16, metadata !38){{.*}}, !noalias !41
